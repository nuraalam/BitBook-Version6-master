            ...
            using (WallEntities db = new WallEntities())
            {
                var ret = (from post in db.Posts.ToList()
                           ...
                           select new
                           {
                               ...
                               PostedByAvatar = imgFolder + (String.IsNullOrEmpty(post.UserProfile.Country) ? defaultAvatar : post.PostedBy + "." + post.UserProfile.Country),
                               ...
                               PostComments = from comment in post.PostComments.ToList()
                                              ...
                                              select new
                                              {
                                                  ...
                                                  CommentedByAvatar = imgFolder + (String.IsNullOrEmpty(comment.UserProfile.Country) ? defaultAvatar : comment.CommentedBy + "." + comment.UserProfile.Country),
        ...
        public void AddPost(Post post)
        {
            ...
            using (WallEntities db = new WallEntities())
            {
                ...
                var ret = new
                {
                    ...
                    PostedByAvatar = imgFolder + (String.IsNullOrEmpty(usr.Country) ? defaultAvatar : post.PostedBy + "." + post.UserProfile.Country),
                    PostedDate = post.PostedDate,
                    Like = post.LikeCount,
                    PostId = post.PostId
                };
        ...
        public dynamic AddComment(PostComment postcomment)
        {
            ...
            using (WallEntities db = new WallEntities())
            {
                ...
                var ret = new
                {
                    ...
                    CommentedByAvatar = imgFolder + (String.IsNullOrEmpty(usr.Country) ? defaultAvatar : postcomment.CommentedBy + "." + postcomment.UserProfile.Country),
